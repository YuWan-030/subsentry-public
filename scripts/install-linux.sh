...
SUBSENTRY_CORS_ALLOW_CREDENTIALS=true
SUBSENTRY_CSRF_ENABLED=true
SUBSENTRY_CSRF_TRUSTED_ORIGINS=$PUBLIC_URL
SUBSENTRY_SESSION_SAME_SITE=lax
SUBSENTRY_SESSION_HTTPS_ONLY=false
SUBSENTRY_ALLOW_PRIVATE_TARGETS=true
...
SUBSENTRY_TURNSTILE_ENABLED=${SUBSENTRY_TURNSTILE_ENABLED:-true}
SUBSENTRY_TURNSTILE_SITE_KEY=${SUBSENTRY_TURNSTILE_SITE_KEY:-}
SUBSENTRY_TURNSTILE_SECRET_KEY=${SUBSENTRY_TURNSTILE_SECRET_KEY:-}
EOF
}
